...
<?php include('partials/header.php'); ?>
    <main class="main">
        <div class="download-fixed">
            <div class="container">
                <a href="#" class="download-fixed__box">
            ...
            <div class="mb100">
                ...
                <div class="partners">
                    <div class="partners__item">
                        <img src="/img/partners/partner1.png" alt="Министерство промышленности и торговли Республики Татарстан" class="partners__img">
                        <span>Министерство<br>промышленности и торговли<br>Республики Татарстан</span>
                    </div>
                    <div class="partners__item">
                        <img src="/img/partners/partner2.png" alt="Агентство Стратегических Инициатив" class="partners__img">
                        <span>Агентство<br>Стратегических Инициатив</span>
                    </div>
                    <div class="partners__item">
                        <img src="/img/partners/partner3.png" alt="Министерство промышленности и торговли Республики Татарстан" class="partners__img">
                        <span>Министерство<br>Здравоохранения<br>Республики Татарстан</span>
                    </div>
                    <div class="partners__item no-text">
                        <img src="/img/partners/partner4.png" alt="Министерство Здравоохранения Республики Татарстан" class="partners__img">
                    </div>
                </div>
            </div>
            <div class="mb100">
                ...
                <div class="reviews">
                    <div class="reviews__item">
                        ...
                        <a href="#" class="reviews__link article">Заседание наблюдательного совета Агентства стратегических инициатив</a>
                    </div>
                    <div class="reviews__item">
                        <div class="reviews__row">
                        ...
                        <a href="#" class="reviews__link article">Медицинский сервис<br>из Татарстана попал в топ инициатив форума «Сильные идеи для нового времени»</a>
                    </div>
                </div>
            </div>
            <div class="mb120">
                ...
                <div class="archievements">
                    <div class="archievements__box square"><span class="body2">Топ-13 проектов форума «Сильные идеи для нового времени»</span></div>
                    <div class="archievements__box round"><span class="body2">Номинация «Начинание года 2021» на премии «Инде»</span></div>
                    <div class="archievements__box square"><span class="body2"> Номинация<br>«Digital-проекта&nbsp;года» в&nbsp;премии Enter</span></div>
                </div>
            </div>
            <div class="mb100">
                <h3 class="subheader square mb40 center">КОНТАКТЫ</h3>
                <div class="contacts">
                    <a href="#" class="contacts__link body1">INSTAGRAM</a>
                    <a href="#" class="contacts__link body1">VKONTAKTE</a>
                    <a href="tg:resolve/#" class="contacts__link body1">TELEGRAM</a>
                    <a href="mailto:Info@svyaz.io" class="contacts__link body1">Info@svyaz.io</a>
                    <a href="tel:78432960860" class="contacts__link body1">+7 843 296 08 60</a>
                </div>
            </div>
        </div>
    </main>
